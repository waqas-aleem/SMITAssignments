            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-md-2 ">
                        <div className="dropdown border border-1 rounded p-1">
                            <button
                                className="btn  dropdown-toggle trendingDropdown"
                                type="button"
                ...
                <div
                    ...
                    <ol className="carousel-indicators">
                        <li
                            ...
                            aria-current="true"
                            aria-label="Slide 1"
                            style={{width:"12px", height:"12px" , marginTop:"5px",border:"1px solid black"}}
                        >
                                        ...
                                        <div className="card shadow-sm p-3 mb-5 bg-body rounded">
                                            <div className="row g-0">
                                                ...
                                                <div className="col-md-8 mt-1 position-relative">
                                                    ...
                                                    <p className="trendingCardheading mx-2">Case Alda</p>
                                                    ...
                                                    <i
                                                        ...
                                                        style={{ color: "#2289FF", fontSize: "18px" }}
                                                    ></i>
                                                    <span className="trendingIconPara ms-2">2 Bath</span>
                                                    <br />
                                                    <button
                                                        type="button"
